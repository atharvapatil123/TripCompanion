...
const Event = () => {
	...
	const {getEvent, fetchEventRequests, acceptUser, rejectUser} = useTripCompanionContext();
                            ...
                            requestedUsers.map((user) => {
                                return <EventCard>
                                    ...
                                    <EventInfoGroup>
                                        ...
                                        <EventInfoValue>{user.gender.toString()}</EventInfoValue>
                                    </EventInfoGroup>
                                    <EventInfoGroup>
                                    ...
                                    {
                                        user.status == 1 && 
                                        event.creator.toLowerCase() === currentAccount.toLowerCase()
                                        && 
                                        <EventRequestActions>
                                        <AcceptBtn 
                                        ...
                                        onClick={() => {
                                            ...
                                            loadingUserAddress === user.walletAddress && isAcceptLoading ?
                                            <BeatLoader color="#ffffff" />
                                            : "Accept"
                                        }</AcceptBtn>
                                        <RejectBtn
                                        disabled={isAcceptLoading || isRejectLoading} onClick={() => {
                                            handleRejectUser(user.walletAddress);
                                        }}>
                                            {
                                                loadingUserAddress === user.walletAddress && isRejectLoading ? 
                                                <BeatLoader color="#ffffff" />
                                                : "Reject"
                                            }
                                        </RejectBtn>
                                    ...
                                    {
                                        user.status == 2 &&
                                        <EventInfoLabelRejected>Rejected</EventInfoLabelRejected>
                                    }
                                    {
                                        user.status == 3 &&
                                        <EventInfoLabelAccepted>Accepted</EventInfoLabelAccepted>
                                    }
                                    {/* <EventActions>
